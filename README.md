...
🎯 **Bioinformatics Researcher | Computational Biologist | Data Scientist**  
...
![Nextflow](https://img.shields.io/badge/Nextflow-2C4D8A?style=for-the-badge&logo=nextflow&logoColor=white)
![scikit-learn](https://img.shields.io/badge/scikit--learn-F7931E?style=for-the-badge&logo=scikit-learn&logoColor=white)
![TensorFlow](https://img.shields.io/badge/TensorFlow-FF6F00?style=for-the-badge&logo=tensorflow&logoColor=white)
![PyTorch](https://img.shields.io/badge/PyTorch-EE4C2C?style=for-the-badge&logo=pytorch&logoColor=white)
![Bioconductor](https://img.shields.io/badge/Bioconductor-3399FF?style=for-the-badge&logo=r&logoColor=white)
...
- **Multi-Omics data analysis (Genomics, Transcriptomics, etc.)**
- **Clinical data**
- **Medical images**
- **NGS data analysis**
- **Single-cell RNA-seq data analysis**
- **Bioinformatics workflows** (QC, alignment, clustering, differential expression, enrichment analysis, etc.)
- **Biostatistical analysis** (PCA, MCA, UMAP, linear models, etc.)
- **Machine Learning & Deep Learning** (supervised/unsupervised, neural networks)
- **Computational environments** (HPC, Conda)
...
⭐️ *“Integrating computation and biology to decode the language of cells.”*
